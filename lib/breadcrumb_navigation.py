        ...
        if url_type == 'image_detail':
            ...
            if image_series:
                ...
                if image_series_category:
                    nav_list.append([image_series.name, 2, image_series.id])
                nav_list.append([image_series.name, 1, image_series.id])
            ...
            if image_series_category:
                nav_list.append([image_series_category.name, 2, image_series_category.id])
    return nav_list

if __name__ == '__main__':
    print breadcrumb_navigation(url)
